<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Banner_ThemMoi.ascx.cs" Inherits="Areas_admin_Banner_Banner_ThemMoi" %>
...
<div class="formthemmoi">
    ...
    <div class="thongTin">
        <div class="tentruong">Ten Banner</div>
        <div class="oNhap">
            <asp:TextBox ID="tbtenbanner" runat="server"></asp:TextBox>
